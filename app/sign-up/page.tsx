...
export default function SignUp() {
    const [accountType, setAccountType] = useState('particuliers')
            ...
            <form
                ...
                <div className="p-8 pb-6">
                    ...
                    <div className="space-y-5">
                        {/* Select pour le type de compte */}
                        <div className="space-y-2">
                            <Label htmlFor="accountType" className="block text-sm">Type de compte</Label>
                            <select
                                id="accountType"
                                name="accountType"
                                value={accountType}
